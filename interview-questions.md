...
Growing up I didn't have a concrete idea of what I wanted to study, but I was completely sure that will be something about science and engineering because I have always been curious, and with a love to resolve riddles. But, at the first, I chose the engineering of mines because my country has a big mining industry. However, I realized that it was not my passion. For what I started to study in parallel what I really wanted, passing from physics, chemistry and finally finding the love for the computing science. 

Before my graduation, I studied by myself two years of computer science, making little codes like automatizing the play of a video game, simples games like the hanged, etc. Until the moment that I found the AI, and I started to focus on these, provoking that I made my thesis about the image recognition and segmentation applied on the geology. 

After my graduation, I worked one year in a company developing AI solutions applied to mining, and I made too a project of video monitoring of a factory taking advantage of the security cameras, where I had to use OpenVino, to achieve real-time processing on CPU. 

And now, I took the desition to start formals studies about computer science, with the AI specialization, where I ask for a preparation year because I want to make stronger my skills, I prefer to take a little more time, but have solid background knowledge 
