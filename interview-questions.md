...
## 10. What’s a Time You Disagreed With a Decision That Was Made at Work?
 1. In one moment, I found that we were trying to make a mineral recognition process with an inefficient algorithm, but our team leader proposed this. So, I searched about the state of art, and I asked for the opportunity to make a short presentation, where I exposed the new algorithm and why it could improve our actual work. At first, I was rejected by my team leader because I couldn't respond to some questions, but the next time I went more prepared, and I had a unanimous votation for change to the new method. After that, a collage helped to improve even my proposal, and I felt good about starting the transition. 
